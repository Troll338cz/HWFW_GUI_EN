...
<div> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
    <tr> 
      <td class="prompt"><table width="100%" border="0" cellspacing="0" cellpadding="0"> 
          <tr> 
            <td class="title_common"  style="padding-left:10px;" width="100%">在本页面上，您可以通过点击“恢复出厂配置”使终端设备的配置恢复为出厂配置并保留关键参数。</td> 
          </tr> 
        </table></td> 
    </tr> 
  </table> 
  ...
  <table width="100%" cellpadding="0" cellspacing="0"> 
    <tr> 
	  ...
	  <input  class = "submit" name="btnRestoreDftCfg" id="btnRestoreDftCfg" type='button' style="width:98px" onClick='RestoreDefaultCfg()' value='恢复出厂配置'></td> 
    </tr> 
  </table> 
</div> 
</body>
