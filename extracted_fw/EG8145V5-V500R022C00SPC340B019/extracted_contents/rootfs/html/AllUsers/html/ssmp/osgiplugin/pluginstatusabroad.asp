...
{
	Result.wapRegCerlinks = PluginStatusLgeDes["s0303"];
}
else if(WapLinkStatus.waplinks == 10 || WapLinkStatus.waplinks == 11)
{
	Result.wapRegCerlinks = PluginStatusLgeDes["s030a"];
}
else if(WapLinkStatus.waplinks == 12)
{
	Result.wapRegCerlinks = PluginStatusLgeDes["s030b"];
}
else
{
...
{
	Result.pluginlinks = PluginStatusLgeDes["s0303"];
}
else if(WapLinkStatus.pluginlinks == 4)
{
	Result.pluginlinks = PluginStatusLgeDes["s030a"];
}
else if(WapLinkStatus.pluginlinks == 5)
{
	Result.pluginlinks = PluginStatusLgeDes["s030b"];
}
else
{
...
<body class="mainbody">
	<script language="JavaScript" type="text/javascript">
		HWCreatePageHeadInfo("pluginstatus", GetDescFormArrayById(PluginStatusLgeDes, "s0100lan"), GetDescFormArrayById(PluginStatusLgeDes, "s0301"), false);
	</script>
