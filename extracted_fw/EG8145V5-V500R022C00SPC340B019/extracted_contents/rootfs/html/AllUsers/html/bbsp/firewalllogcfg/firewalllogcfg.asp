          ...
          <tr> 
            <td> <table cellpadding="0" cellspacing="1" class="tabal_bg" width="100%"> 
                ...
                <tr> 
                  ...
                  <td class="table_right width_per80"> <select id="Direction" name="Direction" onChange="ShowFirewallLogDir()" maxlength='80' class="width_150px" > 
                ...
                <tr> 
                  ...
                  <td class="table_right width_per80"> <select id="Action" name="Action" onChange="ShowFirewallLogAct()" maxlength='80' class="width_100px" > 
