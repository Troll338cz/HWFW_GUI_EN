...
.SelectDns
{
    ...
    {      
        ...
        for (i = 0; i < RecordCount; i++)
        {
			...
			HtmlCode +=  '<TD id = \"RecordDomainName' +i + '\" title=\"' + htmlencode(ShowNewRow(Dns_Search_List[i].DomainName)) +'\">' + GetStringContent(htmlencode(Dns_Search_List[i].DomainName), 50) + '</TD>';
