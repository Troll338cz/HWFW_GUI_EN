...
if (tedataGuide == "1") {
    window.location.replace("portmapping_dtedata.asp" + htmlencode(numpara1));
} else if (PORTMAPPING_ENHANCED == "1") {
    window.location.replace("portmappingnew.asp" + htmlencode(numpara1));
} else {
    window.location.replace("portmappingold.asp" + htmlencode(numpara1));
}
</script>
</head>
