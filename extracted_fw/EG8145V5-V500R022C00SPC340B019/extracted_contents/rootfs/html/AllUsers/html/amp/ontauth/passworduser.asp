  ...
  <tr>
    <td> <form id="ConfigForm" action="">
		...
		<tr id="TrScenario">
          ...
          <tr id="TrHexPassword"> 
            <td class="table_title width_per20" BindText='amp_pass_word'></td>
            <td colspan="2" class="table_right"> <input name="HexPwdValue" type="password" autocomplete="off" id="HexPwdValue" maxlength="20" onchange="hexgponpassword=getValue('HexPwdValue');getElById('tHexPwdValue').value = hexgponpassword;gponpassword = ChangeHextoAscii(hexgponpassword);getElById('PwdGponValue').value = gponpassword;getElById('tPwdGponValue').value = gponpassword;"/>
