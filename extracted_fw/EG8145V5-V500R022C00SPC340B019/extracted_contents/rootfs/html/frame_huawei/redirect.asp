...
{
	document.write("Сбой сетевого соединения. Проверьте соединение для передачи данных или обратитесь к провайдеру услуг.");
}
else if(Language == 'chinese')
{
	document.write("网络连接中断，请检查上行链路连接或联系ISP解决!");
}
