...
function SubmitForm()
{
	...
	if (Username.value == "") {
		AlertEx("User Name is a required field.");
		Username.focus();
		return false;
	}
	...
	var cnt = GetRandCnt();
	var cookie2 = "Cookie=body:" + "Language:" + Language + ":SubmitType=SetAcs" + ":" + "id=-1;path=/";
...
<table   border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<table  border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td><input name="txt_Password_manul" type="password" id="txt_Password_manul" style="width:140px; font-family:Arial" maxlength="127" autocomplete="off" />
		</td>
	</table>
